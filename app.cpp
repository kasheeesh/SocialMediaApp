...
public:
	...
	Menu:
		system("cls");
		cout << "\t\t\t============================" << endl;
		cout << "\t\t\t      PERSONAL TAB MENU     "
			 << "\t(" << FoundRoot->UD.UserName << ")" << endl;
		cout << "\t\t\t============================" << endl;
		cout << endl;
	...
	Menu:
		...
		if (Select == 3)
		{
			system("cls");
			cout << "\t\t\t============================" << endl;
			cout << "\t\t\t  WELCOME IN FRIEND REQUEST "
				 << "\t(" << FoundRoot->UD.UserName << ")" << endl;
			cout << "\t\t\t============================" << endl;
			cout << endl;
	...
	Menu:
		...
		if (Select == 1)
		{
			...
			if (Choice == 1)
			{
				system("cls");
				cout << "\t\t\t============================" << endl;
				cout << "\t\t\t WELCOME IN INDIVIDUAL VIEW "
					 << "\t(" << FoundRoot->UD.UserName << ")" << endl;
				cout << "\t\t\t============================" << endl;
				string Name;
				int PostNo;
			...
			if (Choice == 2)
			{
				system("cls");
				cout << "\t\t\t============================" << endl;
				cout << "\t\t\t WELCOME IN COMMENT SECTION "
					 << "\t(" << FoundRoot->UD.UserName << ")" << endl;
				cout << "\t\t\t============================" << endl;
				cout << endl;
				string Name;
